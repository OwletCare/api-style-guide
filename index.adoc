...
:MUST: pass:[<span class="must-keyword">MUST</span>]
:SHOULD: pass:[<span class="should-keyword">SHOULD</span>]
:MAY: pass:[<span class="may-keyword">MAY</span>]
:MUST-SHOULD: pass:[<span class="must-keyword">MUST</span>/<span class="should-keyword">SHOULD</span>]

// Attributes to improvement design of common table elements.
:NO: pass:[<spa class="must-keyword">&#x2717;</span> No]
...
= Zalando RESTful API and Event Guidelines kittens
